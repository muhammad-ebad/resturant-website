...
const FoodCategory = () => {
  ...
  const items = [
    { id: 1, img: "/category/category1.png", label: "Save 50% on Fast Food" },
    { id: 2, img: "/category/category2.png", label: "Delicious Burgers" },
    { id: 3, img: "/category/category3.png", label: "Healthy Salads" },
    { id: 4, img: "/category/category4.png", label: "Desserts" },
  ];
